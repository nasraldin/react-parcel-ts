...
import { UserSemiPersistentSession } from './types';
...
/**
 * Initial context, used by default until the Context Provider is initialized.
 *
 * @default Empty object, to allow for destructuring even when the context hasn't been initialized (on the server)
 */
