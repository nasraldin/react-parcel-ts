...
import React, { DependencyList, Fragment, useEffect, useState } from 'react';
 ...
 * It can be used to optimize behavior to support both SSG/SSR universally with a different behavior based on the rendering mode.
 ...
 *  If all deps are defined, then we render the children directly because we consider we don't need to wait (optimization, no unnecessary re-render)
 *
 ...
 */
export const DisplayOnBrowserMount: React.FunctionComponent<Props> = (props) => {
